...
const Footer = () => {
  ...
  return (
    ...
    <div className="footer-div bg-[#111e] w-full text-[#fffc] grid grid-cols-2 md:grid-cols-4 items-start pl-[20px] pr-[20px] pt-[10px] pb-[10px]">
    ...
    <p className="text-right text-[#aaa] pr-[17px] col-start-1 col-end-4 md:col-start-3 md:col-end-5">
